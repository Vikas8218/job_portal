...
const Testimonials=()=>{
  return <div className="mt-20 pb-5">
    ...
    {
      testimonials.map((data, index)=>  <div key={index} className="flex flex-col gap-3 w-[24%] border-bright-sun-400 p-2 border   rounded-xl  mt-10">
      ...
      <div className="text-us text-mine-shaft-300">{data.testimonial}</div>
    </div>)
    }
    </div>
  </div>
