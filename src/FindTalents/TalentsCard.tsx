...
const TalentCard=(props:any)=>{
  return <div className="bg-mine-shaft-900 p-3 ease-in-out transition duration-300 w-96 flex flex-col gap-2 rounded-xl  hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400"> 
  ...
  <div className="flex gap-2">
    {
      props.topSkills?.map((skill:any,index:any)=><div key={index} className="p-2 py-1 bg-mine-shaft-800 text-bright-sun-400 rounded-full text-sx">{skill}</div>)
    }
  </div>
  <div>
