...
<div className="flex gap-1  text-lg text-mine-shaft-300 items-center"  >
   ...
   <div className="px-3">
    ...
    <div className="flex flex-wrap gap-2">
      {
        props.skills.map((skills:any, index:any)=><div key={index} className="bg-bright-sun-300 text-sm font-medium bg-opacity-15 rounded-3xl text-bright-sun-400 px-3 py-1">{skills}</div>)
      }
    </div>
   </div>
   <Divider mx="xs"  my="xl"/>
